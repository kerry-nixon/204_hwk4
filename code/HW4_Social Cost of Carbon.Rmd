...
In the provided data set "damages.csv" you have new model estimates of the annual total damages
...
If society were risk averse, policy B with an associated cost of $`r round(max_cost,2)` would be preferred to policy A. Since policy B is now definitely preferred, there is some additional cost above \$`r round(max_cost,2)` that society would be willing to pay in order to stick with policy B. Therefore, the maximum cost of policy B would be higher than it was in the previous question.
